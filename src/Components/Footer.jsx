const Footer = () => {
  return (
    <div className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-8 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 md:space-x-8">
        <a
          target="_blank"
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm">Shams Al Barakat Exhibitions LLC Office: M-09 Arabilla Building, 15C Street, Hor Al Anz East, Dubai -UAE</p>
          </div>
        </a>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm">+97150-3545972</p>
          </div>
        </div>
        <div className="flex items-center">
          <svg
          ...
          <div>
            ...
            <p className="text-sm">info@barakatexhibitions.com</p>
          </div>
        </div>
        <div className="flex items-center">
          <svg
          ...
          <div>
            <h1 className="font-semibold text-sm">2024 by barakatexhibitions</h1>
          </div>
        </div>
      </div>
    </div>
