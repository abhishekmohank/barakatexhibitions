      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm mt-1">+97150-3545972</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className="text-sm mt-1">info@barakatexhibitions.com</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <svg
              fill="currentColor"
            ...
            <h1 className="font-semibold text-sm">2026 by barakatexhibitions</h1>
          </div>
        </div>
      </div>
    </div>
